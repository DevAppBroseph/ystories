    ...
    return GestureDetector(
      ...
      child: ScaleButton(
        ...
        child: Container(
          ...
          margin:
              EdgeInsets.only(top: widget.main ? 0 : 8, right: 5, bottom: 0),
          child: Column(
            ...
            children: [
              Container(
                height: widget.size,
                width: widget.size,
                decoration: widget.userInfo?.stories.stories.isFullViewed !=
                            null &&
                ...
                child: Stack(
                  children: [
                    ...
                    if (widget.userInfo?.stories.stories.isFullViewed != null)
                      ...
                      if (widget
                          .userInfo!.stories.stories.allStories.isNotEmpty)
                        Image.asset(
                          'assets/ellipse.png',
                        )
                    // Image.asset(
