...
class _AccountPageState extends State<AccountPage>
  ...
  Future<void> _showBottomSheetToUpdatePhoto() async {
    var user = Provider.of<AppData>(context, listen: false).stopVideo(true);
    await showModalBottomSheet(
      ...
      var user = Provider.of<AppData>(context, listen: false).stopVideo(false);
    });
    // if (_image != '') {
          ...
          children: [
            Padding(
              ...
              child: StoriesWidget(
                ...
                title: false,
                onTap: () async {
                  Provider.of<AppData>(context, listen: false).stopVideo(true);
