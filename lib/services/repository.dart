...
import 'package:y_storiers/services/objects/get_notif.dart';
...
class Repository {
  ...
  Future<bool?> getNewNotif(String token) async {
    // _removeCertificate();
    dio.options.headers = {"Authorization": "$token"};
    d.Response response = await dio.get("users/get_notif_state");
    try {
      return GetNotifState.fromJson(response.data).state;
    } catch (e) {
      return null;
    }
  }

  Future setNewNotif(String token) async {
    // _removeCertificate();
    dio.options.headers = {"Authorization": "$token"};
    d.Response response = await dio.put("users/set_notif_state");
  }
  ...
  Future<LikeAnswer?> likePosts(String token, int postId) async {
    // _removeCertificate();
    dio.options.headers = {"Authorization": "$token"};
    d.Response response = await dio.put("posts/like_post/$postId");
    // print(response.data);
    try {
  ...
  Future<SubscribeAnswer?> subscribe(String userName, String token) async {
    dio.options.headers = {"Authorization": "$token"};
    d.Response response = await dio.post("users/subscribe/$userName");
    // print(response.data);
    try {
  ...
  Future<SuccessAnswer?> deletePost(String token, int postId) async {
    dio.options.headers = {"Authorization": "$token"};
    d.Response response = await dio.delete("posts/delete_post$postId");
    // print(response.data);
    // try {
    return SuccessAnswer.fromJson(response.data);
    // } catch (e) {
  ...
  Future<SuccessAnswer?> deleteStory(String token, int storyId) async {
    // print(storyId);
    dio.options.headers = {"Authorization": "$token"};
    d.Response response = await dio.delete("stories/delete_story$storyId");
    // print(response.data);
    // try {
    return SuccessAnswer.fromJson(response.data);
    // } catch (e) {
  ...
  Future<void> checkStory(String token, int storyId) async {
    dio.options.headers = {"Authorization": "$token"};
    d.Response response = await dio.put("stories/story$storyId");
  }
